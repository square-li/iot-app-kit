...
## [3.0.0](https://github.com/square-li/iot-app-kit/compare/components-v2.5.1...components-v3.0.0) (2022-11-30)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @iot-app-kit/source-iotsitewise bumped from ^2.5.1 to ^3.0.0
    * @iot-app-kit/table bumped from ^2.5.1 to ^3.0.0
