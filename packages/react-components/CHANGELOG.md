...
## [3.0.0](https://github.com/square-li/iot-app-kit/compare/react-components-v2.5.1...react-components-v3.0.0) (2022-11-30)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @iot-app-kit/components bumped from ^2.5.1 to ^3.0.0
