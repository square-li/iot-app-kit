...
## [3.0.0](https://github.com/square-li/iot-app-kit/compare/scene-composer-v2.5.1...scene-composer-v3.0.0) (2022-11-30)
...
* The following workspace dependencies were updated
  * dependencies
    * @iot-app-kit/core bumped from ^2.5.1 to ^3.0.0
    * @iot-app-kit/related-table bumped from ^2.5.1 to ^3.0.0
  * devDependencies
    * @iot-app-kit/source-iottwinmaker bumped from ^2.5.1 to ^3.0.0
